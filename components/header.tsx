...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 flex h-16 items-center gap-4 border-b bg-background/95 backdrop-blur-xl px-4 md:px-6 shadow-sm">
      ...
      <div className="flex items-center gap-1 md:gap-2">
        ...
        <Button variant="ghost" size="icon" className="rounded-full hover:bg-accent" suppressHydrationWarning>
          <HelpCircle className="h-5 w-5" />
        </Button>
        
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button variant="ghost" size="icon" className="relative rounded-full hover:bg-accent" suppressHydrationWarning>
              <Bell className="h-5 w-5" />
              <Badge className="absolute -right-1 -top-1 h-5 w-5 rounded-full p-0 text-xs bg-primary text-primary-foreground border-2 border-background">
                4
              </Badge>
            </Button>
          </DropdownMenuTrigger>
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button variant="ghost" className="relative h-10 w-10 rounded-full ring-2 ring-border hover:ring-primary/50 transition-all" suppressHydrationWarning>
          ...
          <DropdownMenuContent align="end" className="w-56">
            ...
            <DropdownMenuItem asChild>
              <Link href="/" className="text-destructive cursor-pointer flex items-center gap-2">{t('header.logout')}</Link>
            </DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
      </div>
